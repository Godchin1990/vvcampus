...
public class MyDialog extends Dialog {
	...
	public static class Builder {
		 ...
		 * @return
		 */
		public Builder setBackButton(int backButtonText,
		 ...
		 * @return
		 */
		public Builder setBackButton(String backButtonText,
				DialogInterface.OnClickListener listener) {
		...
		public MyDialog create() {
			...
			// 设置对话框内容
			if (message != null) {
				TextView dlgMsg = (TextView) layout
			...
			if (backButtonText != null) {
				Button bckButton = ((Button) layout
						.findViewById(R.id.dialog_back));
			...
			if (confirmButtonText != null) {
				Button cfmButton = ((Button) layout
