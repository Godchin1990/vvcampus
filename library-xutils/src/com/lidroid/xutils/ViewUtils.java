...
public class ViewUtils {
     ...
     * @param flag
     */
    public static void inject(Object handler, View view,boolean flag) {
    	injectObject(handler, new ViewFinder(view), flag);
    }
     ...
     */
    @SuppressWarnings("ConstantConditions")
    private static void injectObject(Object handler, ViewFinder finder,boolean flag) {

        Class<?> handlerType = handler.getClass().getSuperclass();//获取的是父类的字节码
